...
const SubNavListItem = ({ currentUrl, item, onClick }) => {
  ...
  return (
    <>
      <ListItem button onClick={subMenuClick} className="itemInnerDiv">
        {item.icon && (
