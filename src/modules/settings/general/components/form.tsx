		...
		for (const key in data.countries) {
			countryItems.push(
				<MenuItem
					value={key}
					key={key}
					primaryText={data.countries[key]}
				/>
			)
		}
						...
						<div className="row between-xs middle-xs">
							...
							<div className="col-xs-12 col-sm-6">
								...
								<Field
									...
									floatingLabelText={
										messages.settings_currencySymbol
									}
								/>
								...
								<Field
									...
									floatingLabelText={
										messages.settings_thousandSeparator
									}
								>
									<MenuItem
										value="."
								...
								<Field
									...
									floatingLabelText={
										messages.settings_decimalSeparator
									}
								>
								...
								<Field
									...
									name="decimal_number"
									floatingLabelText={
										messages.settings_numberOfDecimal
									}
								>
