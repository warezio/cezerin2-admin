	...
	<List>
		...
		>
			<ListItem
				...
				leftIcon={
					<FontIcon className="material-icons">swap_calls</FontIcon>
				}
			/>
		</NavLink>
		<NavLink
	...
	<div className="row row--no-gutter col-full-height">
		...
		<div className="col-xs-12 col-sm-8 col-md-9 col--no-gutter scroll col-full-height">
			<Switch>
				...
				<Route
					path="/settings/shipping/add"
					exact
					component={ShippingEdit}
				/>
				<Route
					path="/settings/shipping/:methodId"
					component={ShippingEdit}
				/>
				...
				/>
				<Route
					path="/settings/payments/:methodId"
					component={PaymentsEdit}
				/>
				<Route path="/settings/tokens" exact component={Tokens} />
				<Route
					path="/settings/tokens/add"
					exact
					component={TokensEdit}
				/>
				<Route
					path="/settings/tokens/:tokenId"
					component={TokensEdit}
				/>
